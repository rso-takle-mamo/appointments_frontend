      ...
      <div className="flex">
        <InputGroup>
          ...
          <InputGroupInput
            ...
            placeholder={
              placeholder ||
              `Enter VAT number (${getVatNumberLength(selectedCountry.code)} numbers)...`
            }
            className={cn(
      ...
      <div className="mt-1">
        {showFormatError && (
          <p className="text-sm text-red-500">
            Invalid VAT format for {selectedCountry.name}, expecting{' '}
            {getVatNumberLength(selectedCountry.code)} numbers
          </p>
        )}
        ...
        {isVatValidated && !showFormatError && !error && (
          <div className="flex gap-1 items-center ml-1">
            ...
            <p className="text-sm text-green-600">VAT number validated successfully</p>
          </div>
        )}
      </div>
    </div>
